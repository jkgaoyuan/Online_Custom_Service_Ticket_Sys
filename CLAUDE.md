---
  ...
  |----|------|--------|------|----------|------|
  | T002 | 实现用户认证模块（JWT + RBAC + 登录页面） | P0 | [ ] | 2026-08-07-0108 | M1 核心链路 |
  | T003 | 实现工单核心模块（创建/查询/回复/状态流转） | P0 | [ ] | 2026-08-07-0108 | M1 核心链路 |
  | T004 | 实现智能分派算法 | P0 | [ ] | 2026-08-07-0108 | M1-T20 ~ M2-T5 |
  | T005 | 实现邮件 Webhook 接入 | P0 | [ ] | 2026-08-07-0108 | M2 开始 |
  | T006 | 实现 SLA 管理与超时监控 | P1 | [ ] | 2026-08-07-0108 | M2 |
  | T007 | 实现统计报表与导出 | P1 | [ ] | 2026-08-07-0108 | M2 |
  | T008 | Docker 生产部署配置 | P2 | [ ] | 2026-08-07-0108 | M3 |
